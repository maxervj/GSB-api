...
// POST /api/visiteurs/:visiteurId/portefeuille - Ajoute un praticien au portefeuille
router.post('/:visiteurId/portefeuille', (req, res) => visiteurController.addPraticienToPortefeuille(req, res));

// GET /api/visiteurs/:visiteurId/portefeuille - Récupère le portefeuille d'un visiteur
router.get('/:visiteurId/portefeuille', (req, res) => visiteurController.getPortefeuillePraticiens(req, res));
