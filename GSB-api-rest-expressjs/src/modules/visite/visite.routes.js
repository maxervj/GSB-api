...
import { VisiteController } from '../../Controller/visite.controller.js';
const router = Router();
...
// GET /api/visites/periode - Récupère les visites par période
router.get('/periode', (req, res) => visiteController.getVisitesByDateRange(req, res));
